        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-7">
                    ...
                    <div class="login">
                        @if(!Auth::check())
                            <a href="/login" {{--data-toggle="modal"--}} {{--data-target="#login-modal"--}}><i class="fa fa-sign-in"></i> <span class="hidden-xs text-uppercase">Log in</span></a>
                            <a href="/register"><i class="fa fa-user"></i> <span class="hidden-xs text-uppercase">Register</span></a>
                        @else
                            <a href="/"><i class="fa fa-user"></i> <span class="hidden-xs">{{Auth::user()->email}}</span></a>
                            <a href="/logout"><i class="fa fa-sign-out"></i> <span class="hidden-xs text-uppercase">Logout</span></a>
                        @endif
                    </div>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand home" href="index.html">
                        <img src="/template/img/logo.png" alt="Universal logo" class="hidden-xs hidden-sm">
                        <img src="/template/img/logo-small.png" alt="Universal logo" class="visible-xs visible-sm"><span class="sr-only">Universal - go to homepage</span>
                    </a>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <div class="yamm-content">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img src="/template/img/template-easy-customize.png" class="img-responsive hidden-xs" alt="">
                                            </div>
                                            <div class="col-sm-3">
                                                <h5>Shortcodes</h5>
                                                <ul>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <div class="yamm-content">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img src="/template/img/template-homepage.png" class="img-responsive hidden-xs" alt="">
                                            </div>
                                            <div class="col-sm-3">
                                                <h5>Portfolio</h5>
                                                <ul>

{{--{{ dd(App\User::find(1)->favourites->where('id', 1)->count()) }}--}}
@extends('layouts.app')
...
@section('content')
    <div class="col-md-9">
        ...
        <div class="row" id="productMain">
            <div class="col-sm-6">
                <div id="mainImage">
                    <img src="/template/img/detailbig1.jpg" alt="" class="img-responsive">
                </div>
            ...
            <div class="col-sm-6">
                <div class="box">
                    ...
                    <form>
                        ...
                        <p class="text-center">
                            ...
                            <a href="{{ url("/product/addToBasket", [$product->id])  }}" class="btn btn-template-main"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                            @if(Auth::check() && (Auth::user()->favourites->where('id', $product->id)->count() == 0))
                                <a href="{{ url('product/addToFavourites',['id' => $product->id]) }}"  class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Add to favourites"><i class="fa fa-heart-o"></i></a>
                            @endif

                            @if(Auth::check() && Auth::user()->favourites->where('id', $product->id)->count() > 0)
                                <a href="{{ url('product/removeFromFavourites',['id' => $product->id]) }}"  class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Remove from favourites"><i class="fa fa-thumbs-o-down"></i></a>
                            @endif
                        </p>
                ...
                <div class="row" id="thumbs">
                    <div class="col-xs-4">
                        <a href="/template/img/detailbig1.jpg" class="thumb">
                            <img src="/template/img/detailsquare.jpg" alt="" class="img-responsive">
                        </a>
                    </div>
                    <div class="col-xs-4">
                        <a href="/template/img/detailbig2.jpg" class="thumb">
                            <img src="/template/img/detailsquare2.jpg" alt="" class="img-responsive">
                        </a>
                    </div>
                    <div class="col-xs-4">
                        <a href="/template/img/detailbig3.jpg" class="thumb">
                            <img src="/template/img/detailsquare3.jpg" alt="" class="img-responsive">
                        </a>
                    </div>
                </div>
            </div>
